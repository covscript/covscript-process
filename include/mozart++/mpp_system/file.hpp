...
namespace mpp {
	...
	public:
		...
		int64_t read_position() const
		{
			return _read_pos;
		}
		void advance_read(int64_t n)
		{
			_read_pos += n;
		}

		int64_t write_position() const
		{
			return _write_pos;
		}
		void advance_write(int64_t n)
		{
			_write_pos += n;
		}
